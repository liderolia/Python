...
new_task = []
with open('task_04.txt', 'r', encoding="utf-8") as f_obj:
    for el in f_obj:
        el = el.split(' ', 1)
        new_task.append(f'{my_translate[el[0]]}  {el[1]}')
with open('new_task_04.txt', 'w', encoding="utf-8") as new_obj:
    new_obj.writelines(new_task)
